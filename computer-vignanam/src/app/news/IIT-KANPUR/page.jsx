...
const posts = [
  {
    ...
    desc:
      "అమీర్ పేట్ అమీర్ పేట్ అమీర్ పేట్ ......... ఆంధ్రప్రదేశ్, తెలంగాణా రాష్ట్రాలలో డిగ్రీ కానీ బి. టెక్ గానీ పూర్తి చేసిన తొంబై శాతం మంది విద్యార్థులు...",
  },
  {
    id: 83,
...
export default function IITKanpurListingPage() {
