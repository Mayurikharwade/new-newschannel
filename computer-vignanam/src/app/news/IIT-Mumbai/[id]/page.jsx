...
const posts = [
  {
    id: 79,
    title: "ఐఐటి ముంబై - ప్రతిష్టాత్మక సాంకేతిక సంస్థ",
    image: "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?q=80&w=1200&auto=format&fit=crop",
    category: "ఐ . ఐ . టీ లు",
    time: "10 సంవత్సరాల క్రితం",
    fullContent: [
      "ఐఐటి ముంబై దేశంలోని అత్యుత్తమ సాంకేతిక సంస్థ. ఇది 1958లో స్థాపించబడింది.",
      "ఇక్కడ B.Tech, M.Tech, PhD కోర్సులు అందుబాటులో ఉంటాయి. కంప్యూటర్ సైన్స్, ఎలక్ట్రికల్, మెకానికల్, ఏరోస్పేస్ విభాగాలు ఉన్నాయి.",
      "ఐఐటి ముంబై క్యాంపస్ ముంబై నగరంలో ఉంటుంది. అత్యాధునిక ప్రయోగశాలలు, గ్రంథాలయం, క్రీడా సౌకర్యాలు ఉన్నాయి.",
      "ప్రవేశాలు JEE Advanced పరీక్ష ద్వారా జరుగుతాయి. ప్రతిభావంతులైన విద్యార్థులు మాత్రమే ఇక్కడ చేరతారు.",
      "ప్లేస్మెంట్ అవకాశాలు చాలా బాగుంటాయి. ప్రపంచంలోని ప్రముఖ కంపెనీలు ఇక్కడికి వస్తాయి.",
      "ఐఐటి ముంబై పరిశోధనలో కూడా ముందంజలో ఉంది. ఇక్కడి అధ్యాపకులు అనేక అంతర్జాతీయ పరిశోధన ప్రాజెక్టులలో పాల్గొంటున్నారు.",
      "ఇక్కడ చదివిన విద్యార్థులు ప్రపంచవ్యాప్తంగా ప్రముఖ స్థానాల్లో ఉన్నారు."
    ]
  }
];
...
export default function IITMumbaiDetailPage() {
  ...
  if (!article) {
    return (
      <div style={{ textAlign: "center", padding: "50px" }}>
        ...
        <p>ID: {params.id}</p>
        <button onClick={() => router.push('/news/IIT-Mumbai')}>Go Back</button>
      </div>
    );
  }
