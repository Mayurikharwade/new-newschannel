...
const posts = [
  {
    ...
    desc: "ఐఐటీ తిరుపతి ఆంధ్రప్రదేశ్ లోని ప్రముఖ సాంకేతిక సంస్థ. ఇక్కడ B.Tech, M.Tech, PhD కోర్సులు అందుబాటులో ఉంటాయి.",
  },
];
...
export default function IITTirupatiPage() {
  return (
...
function Card({ post }) {
  ...
  return (
    ...
    >
      <Link href={`/news/IIT-Tirupati/${post.id}`} style={{ textDecoration: "none" }}>
        ...
        <div style={{ padding: "18px", textAlign: "center" }}>
          <h2 style={{ color: "#1e5bd7", fontSize: "18px", lineHeight: "30px", fontWeight: "normal", margin: 0, marginBottom: "8px" }}>
            {post.title}
          </h2>
          <div style={{ marginTop: "8px", marginBottom: "8px", display: "flex", justifyContent: "center", gap: "5px" }}>
          ...
          <p style={{ color: "#777", fontSize: "15px", lineHeight: "28px", textAlign: "left", margin: 0, marginTop: "8px" }}>
            {post.desc}
          </p>
        </div>
