...
const posts = [
  {
    ...
    image:
      "https://computervignanam.net/images/uploads/2017/02/iiit-nuzvid.jpg",
    category: "ఐ . ఐ . ఐ . టీ లు - నూజివీడు",
    time: "10 సంవత్సరాల క్రితం",
    fullContent: [
      "విశాఖపట్నంగా ఏ జిల్లాకి చెందిన ట్రిపుల్ ఐటీ లో ప్రవేశం లభిస్తుంది.",
      "మన రాష్ట్ర విద్యార్థులకు మాత్రమే ఈ అవకాశాలు అందుబాటులో ఉంటాయి.",
      "నూజివీడు ట్రిపుల్ ఐటీ ఆంధ్రప్రదేశ్ లోని ఏలూరు జిల్లాలో ఉంది.",
      "ఇక్కడ బీటెక్, ఎంటెక్ కోర్సులు అందుబాటులో ఉన్నాయి మరియు ప్లేస్‌మెంట్స్ కూడా బాగుంటాయి.",
    ],
  },
];
...
export default function NuziveeduIIITDetailPage() {
  ...
  if (!article) {
    return (
      <div style={{ textAlign: "center", padding: "50px" }}>
        ...
        <p>ID: {params.id} | Available ID: 85</p>
        <button onClick={() => router.push("/news/NUZIVEEDU-IIIT")}>
          Go Back
        </button>
      </div>
    );
