      ...
      >
        <div className="nav-container-custom">
          <ul className="navbar-nav custom-navbar">
            {/* Home */}
            <li className="dropdown home active">
              <Link href="/">హోమ్</Link>
            </li>
...
<div className={`mobile-sidebar ${mobileMenu ? "active" : ""}`}>
  ...
  <ul className="mobile-menu-list">
    ...
    <li>
      ...
      >
        క్యాంపస్ విజ్ఞానం
        <span>{openMenu === "campus" ? "-" : "+"}</span>
      </div>

      <ul className={`mobile-submenu ${openMenu === "campus" ? "show" : ""}`}>

        <li>
          <Link href="/news/Engineering-Colleges">
            ఇంజనీరింగ్ కాలేజీలు
          </Link>
        </li>

        <li>
          <Link href="/news/Universities">
            యూనివర్సిటీలు
          </Link>
        </li>
    ...
    <li>
      ...
      <ul className={`mobile-submenu ${openMenu === "jobs" ? "show" : ""}`}>
        ...
        <li><Link href="/news/Google">Google</Link></li>
        <li><Link href="/news/Facebook">Facebook</Link></li>
        <li><Link href="/news/Microsoft">Microsoft</Link></li>
    ...
    <li>
      ...
      <ul className={`mobile-submenu ${openMenu === "more" ? "show" : ""}`}>
        ...
        <li>
          <Link href="/news/News-Analysys">
            వార్తా విశ్లేషణ
          </Link>
        </li>

        <li>
          <Link href="/news/Guide">
            మార్గదర్శిని ( గైడ్ )
          </Link>
        </li>

        <li>
          <Link href="/news/Reviews">
            రివ్యూ
          </Link>
        </li>

        <li>
          <Link href="/news/Preview">
            ప్రివ్యూ
          </Link>
        </li>
        ...
        <li>
          <Link href="/news/Tips-and-Tricks">
